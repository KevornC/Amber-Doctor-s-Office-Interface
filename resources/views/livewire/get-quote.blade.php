<div>
  ...
  <div
    class="max-w-screen-xl px-8 grid gap-8 grid-cols-1 md:grid-cols-2 md:px-12 lg:px-16 xl:px-32 py-6 mx-auto bg-gray-100 text-gray-900 rounded-lg shadow-lg">
    <div class="flex flex-col justify-between">
      <div>
        <h3 class="text-4xl lg:text-1xl font-bold leading-tight">Lets talk about everything!</h3>
        ...
        <svg class="w-full" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
          ...
          <g opacity="0.1">
            ...
            <path
              ...
              transform="translate(-52 -162.63)" fill="#f44336" />
            <path
          ...
          <ellipse cx="548" cy="493.13" rx="548" ry="8.86" fill="#f44336" opacity="0.1" />
          <ellipse cx="548" cy="565.88" rx="548" ry="8.86" fill="#f44336" opacity="0.1" />
          <ellipse cx="548" cy="341.3" rx="548" ry="8.86" fill="#f44336" opacity="0.1" />
          <ellipse cx="548" cy="417.21" rx="548" ry="8.86" fill="#f44336" opacity="0.1" />
          <path
            ...
            transform="translate(-52 -162.63)" fill="#f44336" opacity="0.1" />
          <path
          ...
          <path
            ...
            transform="translate(-52 -162.63)" fill="#f44366" />
    ...
    <div class="">
      <div>
        ...
        <input class="w-full @error('fullName') border-red-600 @enderror bg-gray-300 text-gray-900 mt-2 p-3 rounded-lg focus:outline-none focus:shadow-outline"
          type="text" placeholder="" wire:model="fullName">
          @error('fullName')
      ...
      <div class="mt-8">
        ...
        <input class=" @error('email') border-red-600 @enderror w-full bg-gray-300 text-gray-900 mt-2 p-3 rounded-lg focus:outline-none focus:shadow-outline"
      ...
      <div class="mt-8">
        ...
        <textarea wire:model="message"
          class="@error('message') border-red-600 @enderror w-full h-32 bg-gray-300 text-gray-900 mt-2 p-3 rounded-lg focus:outline-none focus:shadow-outline"></textarea>
          @error('message')
          <p class="mt-4 italic text-red-500 text-xs">
            {{$message}}
          </p>
